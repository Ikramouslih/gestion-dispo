		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestion disponibilité",
									"targetURL": "#gestiondispo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gestiondispo-display": {
								"semanticObject": "gestiondispo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gestiondispo",
									"url": sap.ui.require.toUrl("gestiondispo")
								}
							}
						}
					}
